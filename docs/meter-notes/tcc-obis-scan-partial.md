...
# SMART TCC (test 3CL) — OBIS ที่สกัดจาก association view จริงของมิเตอร์ (บางส่วน)
...
- **บางส่วน ไม่ใช่ทั้งใบ** — ยังไม่เห็นกลุ่ม ProfileGeneric (billing `0.0.98.x`, LP `1.0.99.x`), Battery (`0.0.96.6.x`), SpecialDays (`0.0.11.0.0.255`), ActivityCalendar ซึ่งมีแน่ตามรูป GXDLMSDirector ของ vendor — รอสแกนรอบเต็มหรือไฟล์ .gxc จากลูกค้า
