> ⚠️ **มิเตอร์ตัวนี้เลิกใช้แล้ว** (ลูกค้ายืนยัน 2026-08-07) — เอกสารนี้เก็บไว้เป็นบันทึกประวัติ
> ของเครื่อง `1252008102` เท่านั้น **เครื่องที่ใช้งานจริงตอนนี้อยู่ใน
> [`smw110w4-scan.md`](smw110w4-scan.md)** ซึ่งสแกนจากของจริง 2026-08-07 และมีข้อที่ต่างจากหน้านี้
> (client address 6 ไม่ใช่ 5 · load profile 20 คอลัมน์ไม่ใช่ 19) — เมื่อสองไฟล์ขัดกัน ให้ยึดไฟล์นั้น
>
