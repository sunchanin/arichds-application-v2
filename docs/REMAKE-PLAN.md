...
| 3 | **M13 ไฟล์ export** | เรียง **formatter ก่อน driver** — billing CSV → Energy file → คอลัมน์ที่ขาด · สองก้อนแรกไม่พึ่งก้อนหลังเลย ลูกค้าได้ของใช้เร็วกว่ามาก · **grill + spec + ticket เสร็จ** `f0967ab` — §7.6 · **7 ticket ยังไม่ implement** |
...
### 7.6 M13 — ไฟล์ export · grill + spec + ticket เสร็จ `f0967ab`
