...
| 5 | **E2** (หลัง ADR) · **E5** (หลังลูกค้าตอบ) | E2 รอคำตัดสิน · E5 คือ 7 หน้าที่ลูกค้าส่งรูปมาแต่ไม่เขียนอะไร ⇒ ไม่มีอะไรให้ซักจนเขาพูด |
| 6 | **build + ส่งมอบ** | เจ้าของสั่งให้ build ทีเดียวหลัง implement ครบ |
...
### 7.8 M14 — E4 push ขึ้น server กลาง · grill 2026-09-14 · ADR 0022 · 0023 · 0024
...
**ขั้นถัดไป**: `/to-spec` ⇒ `/to-tickets` · ชื่อตารางและ field รายตัวของ payload ตัดสินตอน spec
