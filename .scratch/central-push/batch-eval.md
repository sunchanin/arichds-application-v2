...
|---|---|---|---|---|---|---|---|---|---|---|
| 01 | DONE | 42.4 | +1087/−61 | 3.7 | 2 | 0 | 371k / 123k | รอตรวจ | รอตรวจ | +18 |
| 02 | DONE_WITH_FIXES | 40.7 | +958/−211 | 3.5 | 1 | 10.2 | 332k / 106k | รอตรวจ | รอตรวจ | +18 |
| 03 | DONE_WITH_FIXES | 33.7 | +655/−1 | 5.1 | 2 | 8.5 | 245k / 87k | รอตรวจ | รอตรวจ | +27 |
| 04 | DONE_WITH_FIXES | 42.1 | +678/−775 | 2.9 | 1 | 6.0 | 346k / 121k | รอตรวจ | รอตรวจ | −5 |
| 05 | DONE_WITH_FIXES | 37.1 | +676/−109 | 4.7 | 2 | 4.6 | 271k / 101k | รอตรวจ | รอตรวจ | +12 |
| 06 | DONE_WITH_FIXES | 48.6 | +893/−25 | 5.3 | 1 | 7.8 | 358k / 103k | รอตรวจ | รอตรวจ | +21 |
| 07 | DONE_WITH_FIXES | 52.1 | +1585/−8 | 3.3 | 2 | 5.1 | 416k / 139k | รอตรวจ | รอตรวจ | +29 |
| 08 | DONE_WITH_FIXES | 74.8 | +1848/−42 | 4.0 | 2 | 11.1 | 534k / 147k | รอตรวจ | รอตรวจ | +26 |

**สรุปต้นทุน**
- **C1:** median 42.25 นาทีต่อตั๋ว (pipeline เดิม 76)
- **C3:** ไม่มี agent ตาย ไม่มีตั๋วไหนไม่ผ่าน มีมนุษย์เข้ามาครั้งเดียว คือเจ้าของสั่งหยุดหลังตั๋ว 06
  - ตั๋ว 03: implementer หยุดรอ suite ที่รันเบื้องหลัง ต้อง resume หนึ่งครั้ง
  - ตั๋ว 06: orchestrator ส่ง implementer กลับไปเรียก skill ก่อนเข้ารีวิว ใช้เวลา 14.5 นาที ซึ่งไม่ได้นับใน C4

**ข้อควรระวังในการอ่านตัวเลข**
- จำนวนบรรทัดรวมไฟล์ ledger ของตั๋วก่อนหน้าที่ติดไปใน commit เดียวกัน
- tokens เป็นค่าสะสมตัวสุดท้ายของแต่ละ agent
- "เทสต์เพิ่ม" นับจากบรรทัดสรุปของ full suite ก่อนและหลังตั๋วนั้น

**ยังไม่ได้ทำ:** Q1/Q3 (ต้องใช้ agent ใหม่ตรวจ) · C1 ต่อ 100 บรรทัดของ pipeline เดิม · Q2 ของ pipeline เดิมจาก git log
