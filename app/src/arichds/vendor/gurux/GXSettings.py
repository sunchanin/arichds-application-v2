...
class GXSettings:
        ...
        for index in range(1, len(args)):
            if skipNext:
                ...
                try:
                    ...
                    raise ValueError("Invalid parameter: " + args[index]) from None
                c = GXCmdParameter()
                c.tag = args[index][1]
                list_.append(c)
    ...
    def getParameters(self, args):
        parameters = GXSettings.__getParameters(args, "h:p:c:s:r:i:It:a:p:P:g:S:n:C:v:o:T:A:B:D:d:l:W:w:f:L:M:N:E:V:")
        ...
        for it in parameters:
            if it.tag == "r":
                ...
                if it.value.lower() == "Suite0".lower():
                    ...
                    raise ValueError("Invalid Ciphering option: '" + it.value + "'. (Suite0, Suite1, Suite2)")
            elif it.tag == "T":
                ...
                if self.client.standard in (
                    ...
                    raise ValueError(
                        "Invalid DLMS standard option: '" + it.value + "'. (DLMS, India, Italy, SaudiArabia, IDIS)"
                    )
            elif it.tag == "c":
