...
"""PyInstaller spec for probe_billing_scalers.exe — a carry-to-site diagnostic.
...
Build from `app/`:  pyinstaller packaging/probe_billing_scalers.spec
Result:             app/dist/probe_billing_scalers.exe
"""
...
a = Analysis(
    [str(APP_ROOT / "scripts" / "probe_billing_scalers.py")],
