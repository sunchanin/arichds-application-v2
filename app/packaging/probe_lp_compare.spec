...
"""PyInstaller spec for probe_lp_compare.exe — a carry-to-site diagnostic.
...
Build from `app/`:  pyinstaller packaging/probe_lp_compare.spec
Result:             app/dist/probe_lp_compare.exe
"""
...
a = Analysis(
    [str(APP_ROOT / "scripts" / "probe_lp_compare.py")],
