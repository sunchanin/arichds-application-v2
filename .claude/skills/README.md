...
- **[cewe-docs](./cewe-docs/SKILL.md)** — Index of the vendor & reference material in `cewe-docs/`: DLMS/COSEM Blue & Green Books, the OBIS code maps for CEWE meters, the legacy ARICHDS program reference, and the worker deploy guide.